...
public class TblServersWorkInfoHis {
    private int no;
    private int noNew;
    ...
    public boolean equals(Object o) {
        ...
        TblServersWorkInfoHis that = (TblServersWorkInfoHis) o;
        return no == that.no &&
                noNew == that.noNew &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(no, noNew, operatorType, contentType, commNm, commTel, clientSrc, itemType, mchtBrhNo, isUrgent, status, lastDate, remark, identityPic, recCrtOpr, recCrtTs, recUpdOpr, recUpdTs);
    }
}
